...
const routes = [
  ...
  { path: '/finances/create', component: () => import(/* webpackChunkName: "FinanceForm" */ '@/Pages/Office/FinanceForm.vue'), name: 'FinanceForm' },
  { path: '/finances-groups', component: () => import(/* webpackChunkName: "FinanceGroup" */ '@/Pages/Office/FinanceGroup.vue'), name: 'FinanceGroup' },
  { path: '/finances-groups/create', component: () => import(/* webpackChunkName: "FinanceGroupForm" */ '@/Pages/Office/FinanceGroupForm.vue'), name: 'FinanceGroupForm' },
