...
<template>
  ...
  <h3 class="mt-5 mb-1 font-bold text-sm">С алфавитом</h3>
  <div style="height: 400px">
    <StackedListWithHeadings class="mt-2" :items="directory" />
  </div>

  <h3 class="mt-5 mb-1 font-bold text-sm">Обычные</h3>
  <div style="height: 400px">
    <StackedList class="mt-2" :items="items" />
  </div>
</template>
