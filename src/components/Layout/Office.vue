      ...
      <div class="flex flex-col w-64 border-r border-gray-200 pt-3 pb-4 bg-gray-100">
        ...
        <div class="h-0 flex-1 flex flex-col overflow-y-auto" id="sidebar-holder">
          <Dropdown :items="userMenu" direction="justify" class="px-3 mt-4">
            <MenuButton class="group w-full bg-gray-100 rounded-md py-2 text-sm text-left font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-500" >
