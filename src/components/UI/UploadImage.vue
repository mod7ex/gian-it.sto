  ...
  <div class="flex-grow lg:mt-0 lg:mr-6 lg:flex-grow-0 lg:flex-shrink-0">
    ...
    <div class="mt-1 lg:hidden">
      <div class="flex items-center">
        <div
          :class="[
            'flex-shrink-0 inline-block overflow-hidde',
            { 'rounded-full': props.rounded },
            props.full ? 'h-full' : 'h-12',
            props.full ? 'w-full' : 'w-12',
          ]"
          aria-hidden="true"
        >
          <img
        ...
        <div class="ml-5 rounded-md shadow-sm">
          ...
          >
            ...
            <span
              v-if="props.loader"
              class="absolute border-2 mr-1 border-blue-400 borderTopColorTransparent border-solid rounded-full animate-spin w-5 h-5"
            ></span>
    ...
    <div
      :class="[
        'hidden relative overflow-hidden lg:block',
        { 'rounded-full': props.rounded },
      ]"
    >
      <img
      ...
      >
        ...
        <div
          v-if="props.loader"
          class="absolute border-2 mr-1 border-blue-400 borderTopColorTransparent border-solid rounded-full animate-spin w-8 h-8"
        ></div>
    ...
    <label
      :for="id"
      class="mt-3 block flex justify-center text-sm text-center cursor-pointer hidden lg:block"
    >
      Загрузить
    </label>
